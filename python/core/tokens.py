...
# lido do .env porque muda a cada atualização da base. Cada tema decide se usa
# isto ou o próprio campo "ano" dentro do JSON de dados (ver SCHEMA.md de cada
# tema) — nenhum dos dois é obrigatório.
...
PAGE_SIZE = (21 * cm, 29.7 * cm)   # A4 retrato — ver CLAUDE.md "Formato da página"

STRIPE_W  = 20    # largura da borda lateral azul (pt)
MARGIN    = 36    # margem interna (pt)
CONTENT_W = PAGE_SIZE[0] - STRIPE_W - MARGIN * 2   # largura útil de conteúdo
